...
const apiService = {
  ...
  async submitReply(replyText, parentId, courseId) {
    try {
      const response = await fetch("https://ycspout.umwalimu.com/api/student/comment.php", {
        method: "POST",
        headers: {
  ...
  getCurrentUser() {
    ...
    return userStr ? JSON.parse(userStr) : navigate("/login");
  },
...
// 2. Replace the loadComments function with this memoized version:
const loadComments = useCallback(async (videoId = null, courseId = null) => {
  if (!courseId) return; // Don't load if no course ID
...
// 3. Remove ALL useEffects that call loadComments and replace with this single one:
useEffect(() => {
  // Only load comments when course actually changes, not on every render
  ...
  // Memoized loadEnrolledCourses function
  ...
  const submitRecording = async () => {
    ...
    const recordingUrl = `httpss://recordings.ycspout.rw/student_${currentUser.id}/task_${selectedTask.id}_${Date.now()}.mp4`;
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
              <div className="relative">
                <iframe
                  width="100%"
                  height="400"
                  src={`httpss://www.youtube.com/embed/${courseDetail.youtube_url || 'dQw4w9WgXcQ'}?rel=0&modestbranding=1`}
            ...
            {/* Comments Section - No form element */}
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-2">
                {/* <button
                  onClick={() => handleVideoComplete(courseDetail.id)}
