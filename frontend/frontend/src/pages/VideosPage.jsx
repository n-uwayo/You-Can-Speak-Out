...
const VideosPage = () => {
  ...
  const fetchVideos = async () => {
    ...
    try {
      const response = await fetch('https://ycspout.umwalimu.com/api/get_videos.php');
  ...
  const handleSubmit = async e => {
    ...
    try {
      const response = await fetch('https://ycspout.umwalimu.com/api/add_video.php', {
        method: 'POST',
  ...
  const handleDelete = async (videoId) => {
    if (window.confirm('Are you sure you want to delete this video?')) {
      try {
        const response = await fetch(`https://ycspout.umwalimu.com/api/delete_video.php?id=${videoId}`, {
          method: 'DELETE',
        });
