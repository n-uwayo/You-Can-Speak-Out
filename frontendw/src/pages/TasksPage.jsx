...
const TasksPage = () => {
  ...
  // PHP API base URL
  const API_BASE_URL = 'https://ycspout.umwalimu.com/api'; // Update this to match your PHP API folder
  ...
  const handleSubmit = async () => {
    if (!formData.title || !formData.courseId || !formData.dueDate || !formData.description) {
      alert('Please fill in all required fields (Title, Course, Due Date, and Description)');
      return;
    }
  ...
  const handleEdit = (task) => {
    ...
    setFormData({
      ...
      courseId: task.courseId || courseInfo.id || ''
    });
  ...
  const filteredTasks = categorizedTasks[activeTab]?.filter(task =>
    ...
    task.course?.title?.toLowerCase().includes(searchTerm.toLowerCase())
  ) || [];
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
        <div>
          ...
          <p className="text-gray-600">Manage assignments and assessments for your courses</p>
          ...
          <div className="flex items-start">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-yellow-700 mb-4">
                Your backend doesn't have the tasks endpoints yet. You need the following PHP file:
              </p>
